...
from person.views import BaseView


@view_defaults(route_name='create_person', permission=NO_PERMISSION_REQUIRED, renderer='json')
...
class PersonViewPost(PersonView):
